% =========================================================================
% Figure 1f: Behavioral Improvements 
% =========================================================================

% Load behavioral improvement data and standard errors
load('Fig_1f.mat', 'MPI', 'SE');
...
figure('Name', 'Figure 1f', 'Position', [100, 100, 500, 500], 'Color', 'w');
hold on;
...
% Aesthetics: hide top/right axes, thicken visible axes, format ticks
box off;
